...
namespace DitzelGames.FastIK
{
    class SampleProcedualAnimation :  MonoBehaviour
    {
        ...
        public void LateUpdate()
        {
            ...
            Step2.Translate(Vector3.forward * Time.deltaTime * 0.7f);
            if (Step2.position.z > 1f)
                Step2.position = Step2.position + Vector3.forward * -2f;
            Step3.Translate(Vector3.forward * Time.deltaTime * 0.7f);
            if (Step3.position.z > 1f)
                Step3.position = Step3.position + Vector3.forward * -2f;
            Step4.Translate(Vector3.forward * Time.deltaTime * 0.7f);
            if (Step4.position.z > 1f)
                Step4.position = Step4.position + Vector3.forward * -2f;
